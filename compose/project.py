...
class Project(object):
    ...
    """
    def __init__(self, name, services, client, networks=None, volumes=None, config_version=None, builder=None):
        self.name = name
    ...
    @classmethod
    def from_config(cls, name, config_data, client, default_platform=None, extra_labels=None, builder=None):
        """
    ...
    def build(self, service_names=None, no_cache=False, pull=False, force_rm=False, memory=None,
        ...
        def build_service(service):
            service.build(no_cache, pull, force_rm, memory, build_args, gzip, rm, silent, progress=progress)
